        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold mb-2">Payment Session Expired</h2>
              <p className="text-muted-foreground mb-4">
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Amount */}
          <div className="bg-green-500/10 p-4 rounded-lg border border-green-200 dark:border-green-800">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-700 dark:text-green-400">Amount to Transfer</p>
              ...
              <Button
                variant="outline"
                size="sm"
                className="border-green-300 dark:border-green-700 text-green-700 dark:text-green-400 hover:bg-green-500/10"
